	...
	integration_request = frappe.get_doc(
		{
			...
			"request_headers": get_json(request_headers) if request_headers else None,
			"data": get_json(data) if data else None,
			"output": get_json(output) if output else None,
			"error": get_json(error) if error else None,
